...
#pragma warning restore 414, 0649
    ...
    public void SetVR(){
        isVR = !isVR;
        controlMethod = (isVR)?CUIControlMethod.GAZE:CUIControlMethod.MOUSE;
        pointer.SetActive(isVR);
    }
    ...
    public override void Process()
    {
        switch (controlMethod)
        {
            ...
            case CUIControlMethod.WEBXR:
            {
                ProcessWebXRController();
                break;
            }
    ...
    #region EVENT PROCESSING - WEBXR
    protected virtual void ProcessWebXRController() {
