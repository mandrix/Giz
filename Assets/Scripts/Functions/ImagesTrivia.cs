...
public class ImagesTrivia : MonoBehaviour
{
    ...
    IEnumerator AppearAnswer() {
        ...
        for (int i = 0; i < imageOptions.Length; i++)
        {
            imageOptions[i].transform.GetChild(1).gameObject.SetActive(true);
            imageOptions[i].transform.GetChild(4).gameObject.SetActive(true);
            imageOptions[i].transform.GetChild(5).gameObject.SetActive(true);
    ...
    private void CheckAnswers()
    {
        ...
        if (completed)
        {
            ...
            for (int i = 0; i < imageOptions.Length; i++)
            {
                if (imageOptions[i].transform.GetChild(3).gameObject.activeInHierarchy)
                {
                    if (!(imageOptions[i].transform.GetChild(4).GetComponent<Image>().enabled))
                    {
    ...
    IEnumerator BadAnswer()
    {
        ...
        for (int i = 0; i < imageOptions.Length; i++)
        {
            imageOptions[i].transform.GetChild(1).gameObject.SetActive(false);
            imageOptions[i].transform.GetChild(2).gameObject.SetActive(false);
            imageOptions[i].transform.GetChild(3).gameObject.SetActive(false);
