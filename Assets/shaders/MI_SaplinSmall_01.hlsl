...
void InitializeExpressions()
{
	...
	Material.VectorExpressions[8] = float4(4.000000,3.000000,1.000000,0.000000);//(Unknown)
	...
	Material.VectorExpressions[15] = float4(0.299080,0.840278,0.035012,1.000000);//Translucency_Color
	Material.VectorExpressions[16] = float4(0.299080,0.840278,0.035012,0.000000);//(Unknown)
	Material.ScalarExpressions[0] = float4(0.500000,0.000000,-0.200000,1.250000);//Normal_strengh (Unknown) desaturate Brightness
	Material.ScalarExpressions[1] = float4(0.220000,1.000000,1.000000,0.500000);//Specular Roughness Vertex_AO AO_Threshold
	...
	Material.ScalarExpressions[3] = float4(0.050000,4.000000,1.000000,0.000000);//Wind Horizontal Speed  (Unknown) Wind Gust World Scale Wind Angle Offset 1
	...
	Material.ScalarExpressions[8] = float4(2.000000,200.000000,0.250000,131.000000);//Dampening Radius Multiplier 2 Wind 2 Random Rotation Change Rate Wind 2 Random Rotation Influence Sphere_Mask Radius
	Material.ScalarExpressions[9] = float4(131.000000,0.007634,32.000000,2048.000000);//(Unknown) (Unknown) Object_Scale Wind_Dist_Divide
	Material.ScalarExpressions[10] = float4(2.000000,-1.000000,3.000000,0.000000);//Wind_Distance_Contrast (Unknown) translucency_blend_albedo __SubsurfaceProfile
