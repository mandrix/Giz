...
void InitializeExpressions()
{
	...
	Material.VectorExpressions[2] = float4(0.619052,0.914931,0.565045,1.000000);//albedo_color
	Material.VectorExpressions[3] = float4(0.619052,0.914931,0.565045,0.000000);//(Unknown)
	...
	Material.VectorExpressions[15] = float4(0.875360,0.989583,0.013744,1.000000);//Translucency_Color
	Material.VectorExpressions[16] = float4(0.875360,0.989583,0.013744,0.000000);//(Unknown)
	Material.ScalarExpressions[0] = float4(0.300000,0.000000,0.020000,0.100000);//Normal_strengh (Unknown) color_variation desaturate
	Material.ScalarExpressions[1] = float4(1.500000,0.220000,1.000000,1.000000);//Brightness Specular Roughness Translucency_Opacity
	Material.ScalarExpressions[2] = float4(0.009174,0.100000,1.000000,0.050000);//Max Rotation 1 Wind Speed Local Wind Scale 1 Wind Horizontal Speed 
	Material.ScalarExpressions[3] = float4(3.000000,1.000000,0.000000,-0.444000);//(Unknown) Wind Gust World Scale Wind Angle Offset 1 Wind 1 Shelter Dot Product Modulation 
