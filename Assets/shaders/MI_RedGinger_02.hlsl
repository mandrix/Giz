...
void InitializeExpressions()
{
	...
	Material.ScalarExpressions[0] = float4(0.600000,0.000000,0.100000,1.000000);//Normal_strengh (Unknown) desaturate Brightness
	Material.ScalarExpressions[1] = float4(0.500000,1.500000,0.750000,0.500000);//Specular Roughness Vertex_AO AO_Threshold
	Material.ScalarExpressions[2] = float4(1.500000,0.009174,0.100000,1.000000);//Translucency_Opacity Max Rotation 1 Wind Speed Local Wind Scale 1
	...
	Material.ScalarExpressions[8] = float4(2.000000,200.000000,0.250000,125.000000);//Dampening Radius Multiplier 2 Wind 2 Random Rotation Change Rate Wind 2 Random Rotation Influence Sphere_Mask Radius
	Material.ScalarExpressions[9] = float4(125.000000,0.008000,21.661612,2048.000000);//(Unknown) (Unknown) Object_Scale Wind_Dist_Divide
