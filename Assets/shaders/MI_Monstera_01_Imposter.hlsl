...
void InitializeExpressions()
{
	...
	Material.ScalarExpressions[0] = float4(3.374976,4.000000,4.000000,0.375000);//NORMAL ROTATE AMT Frames_X (Unknown) ImposterRoundingOffsetX
	Material.ScalarExpressions[1] = float4(0.250000,-1.570796,0.785398,1.000000);//(Unknown) (Unknown) (Unknown) ZRot
	Material.ScalarExpressions[2] = float4(1.000000,1.400000,0.714286,0.150000);//(Unknown) Brightness (Unknown) Emissive_Power
	Material.ScalarExpressions[3] = float4(0.000000,0.000000,0.000000,0.800000);//(Unknown) Metalic Specular Roughness
	Material.ScalarExpressions[4] = float4(134.970779,-0.588890,1.000000,4.000000);//Imposter_Size Sprite_Z_Correction Ambient_Occlusion Frames_Y
