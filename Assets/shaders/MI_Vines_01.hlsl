...
void InitializeExpressions()
{
	...
	Material.VectorExpressions[2] = float4(0.788620,0.906250,0.516563,1.000000);//Albedo_Color
	Material.VectorExpressions[3] = float4(0.788620,0.906250,0.516563,0.000000);//(Unknown)
	Material.VectorExpressions[4] = float4(0.382336,0.463542,0.057369,1.000000);//Translucency_Color
	Material.VectorExpressions[5] = float4(0.382336,0.463542,0.057369,0.000000);//(Unknown)
	Material.ScalarExpressions[0] = float4(1.000000,0.000000,0.000000,0.500000);//Normal_strengh (Unknown) Albedo_Desaturate Specular
	Material.ScalarExpressions[1] = float4(1.000000,0.880000,1.000000,1.000000);//Roughness Opacity Wind_Speed_Power Wind_Sway_Height
	...
	Material.ScalarExpressions[3] = float4(0.000000,1.000000,1.500000,0.000000);//Leaves Wind Force translucency_blend_albedo Translucency Power __SubsurfaceProfile
	Material.ScalarExpressions[4] = float4(0.500000,0.000000,0.000000,0.000000);//AO_Threshold (Unknown) (Unknown) (Unknown)
