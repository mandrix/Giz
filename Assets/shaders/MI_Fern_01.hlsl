...
void InitializeExpressions()
{
	...
	Material.VectorExpressions[2] = float4(0.671875,0.590219,0.345252,1.000000);//albedo_color
	Material.VectorExpressions[3] = float4(0.671875,0.590219,0.345252,0.000000);//(Unknown)
	...
	Material.VectorExpressions[8] = float4(7.000000,3.000000,1.000000,0.000000);//(Unknown)
	...
	Material.VectorExpressions[15] = float4(0.318407,0.364583,0.068359,1.000000);//Translucency_Color
	Material.VectorExpressions[16] = float4(0.318407,0.364583,0.068359,0.000000);//(Unknown)
	...
	Material.ScalarExpressions[5] = float4(2.000000,200.000000,2.000000,0.000000);//Dampening Radius Multiplier 1 Wind 1 Random Rotation Change Rate Wind 1 Random Rotation Influence Wind 1's Angle Contribution to Wind 2
