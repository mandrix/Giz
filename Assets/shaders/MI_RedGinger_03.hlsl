...
void InitializeExpressions()
{
	...
	Material.VectorExpressions[2] = float4(0.854167,0.793475,0.442853,1.000000);//albedo_color
	Material.VectorExpressions[3] = float4(0.854167,0.793475,0.442853,0.000000);//(Unknown)
	...
	Material.ScalarExpressions[0] = float4(0.850000,0.000000,0.000000,1.000000);//Normal_strengh (Unknown) desaturate Brightness
	Material.ScalarExpressions[1] = float4(0.350000,1.000000,0.550000,0.650000);//Specular Roughness Vertex_AO AO_Threshold
	...
	Material.ScalarExpressions[8] = float4(2.000000,200.000000,0.250000,140.000000);//Dampening Radius Multiplier 2 Wind 2 Random Rotation Change Rate Wind 2 Random Rotation Influence Sphere_Mask Radius
	Material.ScalarExpressions[9] = float4(140.000000,0.007143,21.661612,2048.000000);//(Unknown) (Unknown) Object_Scale Wind_Dist_Divide
