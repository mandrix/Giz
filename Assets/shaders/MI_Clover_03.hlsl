...
void InitializeExpressions()
{
	...
	Material.VectorExpressions[2] = float4(0.661632,0.869792,0.158556,1.000000);//albedo_color
	Material.VectorExpressions[3] = float4(0.661632,0.869792,0.158556,0.000000);//(Unknown)
	Material.VectorExpressions[4] = float4(0.538437,0.895833,0.303277,1.000000);//Translucency_Color
	Material.VectorExpressions[5] = float4(0.538437,0.895833,0.303277,0.000000);//(Unknown)
	Material.ScalarExpressions[0] = float4(1.000000,0.000000,0.150000,0.900000);//Normal_strengh (Unknown) desaturate Brightness
	Material.ScalarExpressions[1] = float4(0.220000,0.850000,0.500000,0.500000);//Specular Roughness Vertex_AO AO_Threshold
	Material.ScalarExpressions[2] = float4(1.000000,2.000000,0.000000,0.000000);//Translucency_Opacity translucency_blend_albedo __SubsurfaceProfile (Unknown)
