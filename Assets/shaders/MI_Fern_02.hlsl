...
void InitializeExpressions()
{
	...
	Material.VectorExpressions[2] = float4(0.882911,0.953125,0.697867,1.000000);//albedo_color
	Material.VectorExpressions[3] = float4(0.882911,0.953125,0.697867,0.000000);//(Unknown)
	...
	Material.VectorExpressions[8] = float4(7.000000,2.000000,1.000000,0.000000);//(Unknown)
	...
	Material.VectorExpressions[15] = float4(0.273596,0.343750,0.048340,1.000000);//Translucency_Color
	Material.VectorExpressions[16] = float4(0.273596,0.343750,0.048340,0.000000);//(Unknown)
	Material.ScalarExpressions[0] = float4(1.000000,0.000000,0.100000,0.600000);//Normal_strengh (Unknown) desaturate Brightness
	Material.ScalarExpressions[1] = float4(0.220000,0.850000,0.500000,0.500000);//Specular Roughness Vertex_AO AO_Threshold
	...
	Material.ScalarExpressions[3] = float4(0.050000,7.000000,1.000000,0.000000);//Wind Horizontal Speed  (Unknown) Wind Gust World Scale Wind Angle Offset 1
	...
	Material.ScalarExpressions[6] = float4(1.000000,0.100000,0.000000,0.009174);//Local Wind Scale 2 (Unknown) Wind Angle offset 2 Max Rotation 2
