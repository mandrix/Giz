...
void InitializeExpressions()
{
	...
	Material.VectorExpressions[2] = float4(0.408140,0.468750,0.400391,1.000000);//albedo_color
	Material.VectorExpressions[3] = float4(0.408140,0.468750,0.400391,0.000000);//(Unknown)
	...
	Material.VectorExpressions[8] = float4(5.000000,3.000000,1.000000,0.000000);//(Unknown)
	...
	Material.VectorExpressions[15] = float4(0.417752,0.512500,0.057191,1.000000);//Translucency_Color
	Material.VectorExpressions[16] = float4(0.417752,0.512500,0.057191,0.000000);//(Unknown)
	Material.ScalarExpressions[0] = float4(0.400000,0.000000,0.000000,1.000000);//Normal_strengh (Unknown) desaturate Brightness
	...
	Material.ScalarExpressions[3] = float4(0.050000,5.000000,1.000000,0.000000);//Wind Horizontal Speed  (Unknown) Wind Gust World Scale Wind Angle Offset 1
...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat3 Local13 = (Local12 * Material.ScalarExpressions[0].w);
	MaterialFloat Local14 = MaterialStoreTexCoordScale(Parameters, Parameters.TexCoords[0].xy, 1);
	...
	MaterialFloat Local17 = (Local15.g * Material.ScalarExpressions[1].y);
	MaterialFloat Local18 = lerp(0.00000000,1.00000000,Parameters.VertexColor.r);
	MaterialFloat Local19 = (Local15.r * Local18);
	MaterialFloat Local20 = (Local19 * Material.ScalarExpressions[1].z);
	MaterialFloat Local21 = min(max(Local20,0.00000000),1.00000000);
	MaterialFloat Local22 = (Local21 + Material.ScalarExpressions[1].w);
	MaterialFloat Local23 = (1.00000000 - Local22);
	MaterialFloat Local24 = min(max(Local23,0.00000000),1.00000000);
	MaterialFloat Local25 = lerp(Local17,1.00000000,Local24);
	MaterialFloat Local26 = (Material.ScalarExpressions[2].x * Local15.b);
	MaterialFloat3 Local297 = (Local8.rgb * Local15.b);
	MaterialFloat3 Local298 = (Local297 * Material.VectorExpressions[16].rgb);
	MaterialFloat3 Local299 = (Local298 * Material.ScalarExpressions[10].z);
	...
	PixelMaterialInputs.Subsurface = MaterialFloat4(Local299,Material.ScalarExpressions[10].w);
