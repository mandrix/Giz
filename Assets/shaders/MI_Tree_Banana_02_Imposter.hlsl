...
void InitializeExpressions()
{
	...
	Material.ScalarExpressions[0] = float4(0.361905,4.000000,4.000000,1.000000);//NORMAL ROTATE AMT Frames_X (Unknown) ImposterRoundingOffsetX
	...
	Material.ScalarExpressions[4] = float4(500.000000,-0.207937,1.000000,4.000000);//Imposter_Size Sprite_Z_Correction Ambient_Occlusion Frames_Y
