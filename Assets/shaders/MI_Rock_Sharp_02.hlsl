...
void InitializeExpressions()
{
	...
	Material.VectorExpressions[2] = float4(1.000000,0.975316,0.703313,1.000000);//Color_Tint
	Material.VectorExpressions[3] = float4(1.000000,0.975316,0.703313,0.000000);//(Unknown)
	Material.ScalarExpressions[0] = float4(20.000000,3.000000,1.500000,1.500000);//Details_Scale Moss_Tiling Blend_Normal WorldBlendMax
	Material.ScalarExpressions[1] = float4(1.000000,0.000000,0.700000,1.000000);//Moss_Opacity (Unknown) Albedo_Brightness Moss_Power
	Material.ScalarExpressions[2] = float4(0.500000,0.500000,0.500000,0.850000);//Moss_Edge_Brightness Moss_Darkness_Core Specular Roughness
