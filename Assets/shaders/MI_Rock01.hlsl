...
void InitializeExpressions()
{
	...
	Material.ScalarExpressions[0] = float4(5.000000,0.000000,2.000000,0.500000);//Details_Scale (Unknown) Albedo_Brightness Specular
	Material.ScalarExpressions[1] = float4(1.500000,1.000000,0.000000,0.000000);//Roughness AO_power (Unknown) (Unknown)
