...
void InitializeExpressions()
{
	...
	Material.VectorExpressions[2] = float4(0.776711,1.000000,0.671875,1.000000);//albedo_color
	Material.VectorExpressions[3] = float4(0.776711,1.000000,0.671875,0.000000);//(Unknown)
	...
	Material.VectorExpressions[8] = float4(3.000000,2.000000,1.000000,0.000000);//(Unknown)
	...
	Material.VectorExpressions[15] = float4(0.782728,0.831597,0.042588,1.000000);//Translucency_Color
	Material.VectorExpressions[16] = float4(0.782728,0.831597,0.042588,0.000000);//(Unknown)
	Material.ScalarExpressions[0] = float4(0.500000,0.000000,0.100000,1.000000);//Normal_strengh (Unknown) desaturate Brightness
	Material.ScalarExpressions[1] = float4(0.500000,1.000000,0.500000,0.750000);//Specular Roughness Vertex_AO AO_Threshold
	Material.ScalarExpressions[2] = float4(0.800000,0.009174,0.100000,1.000000);//Translucency_Opacity Max Rotation 1 Wind Speed Local Wind Scale 1
	...
	Material.ScalarExpressions[10] = float4(2.000000,-1.000000,2.000000,0.000000);//Wind_Distance_Contrast (Unknown) translucency_blend_albedo __SubsurfaceProfile
