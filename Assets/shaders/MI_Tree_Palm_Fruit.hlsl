...
void InitializeExpressions()
{
	...
	Material.VectorExpressions[2] = float4(0.772570,0.772570,0.772570,1.000000);//AlbedoColor
	Material.VectorExpressions[3] = float4(0.772570,0.772570,0.772570,0.000000);//(Unknown)
	...
	Material.VectorExpressions[7] = float4(0.000000,0.000000,0.000000,1.000000);//SubsurfaceColor
	Material.VectorExpressions[8] = float4(0.000000,0.000000,0.000000,0.000000);//(Unknown)
	Material.ScalarExpressions[0] = float4(0.000000,0.000000,0.000000,0.220000);//Normal_Flatten (Unknown) Desaturation Specular
	Material.ScalarExpressions[1] = float4(1.000000,1.000000,1.000000,2.000000);//Roughness Value Opacity (Unknown) Wind Direction Mask Bias
	Material.ScalarExpressions[2] = float4(0.500000,300000.000000,1024.000000,-0.100000);//Wind Direction Mask Scale Mask Distance Divisor Distance from pivot animation offset distance Distance from pivot animation offset Amount
	Material.ScalarExpressions[3] = float4(8192.000000,0.000000,-0.217400,0.500000);//Directional Per Vertex Wind Offset Rate Random Anim Offset Alpha Anim Offset Values Anim Speed
	Material.ScalarExpressions[4] = float4(256.000000,0.000000,0.000000,0.125000);//Directional Per Pivot Wind Offset Rate Random per leaf anim offset over time Rotation Amount Trunk Sway speed
	Material.ScalarExpressions[5] = float4(0.003000,0.000000,0.000000,1.000000);//Trunk Sway Amount SSS Value __SubsurfaceProfile AO Value
