...
void InitializeExpressions()
{
	...
	Material.VectorExpressions[2] = float4(0.738108,0.834375,0.598622,1.000000);//Albedo_Color
	Material.VectorExpressions[3] = float4(0.738108,0.834375,0.598622,0.000000);//(Unknown)
	...
	Material.ScalarExpressions[1] = float4(1.500000,1.000000,1.000000,1.000000);//Roughness Opacity Wind_Speed_Power Wind_Sway_Height
	...
	Material.ScalarExpressions[3] = float4(0.500000,1.500000,2.000000,0.000000);//Leaves Wind Force translucency_blend_albedo Translucency Power __SubsurfaceProfile
