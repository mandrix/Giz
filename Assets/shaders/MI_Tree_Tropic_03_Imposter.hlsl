...
void InitializeExpressions()
{
	...
	Material.VectorExpressions[5] = float4(0.000000,0.000000,-1.000000,0.000000);//FWD
	Material.VectorExpressions[6] = float4(0.000000,0.000000,-1.000000,0.000000);//(Unknown)
	Material.VectorExpressions[7] = float4(0.666667,1.000000,1.000000,0.000000);//Color_Tint
	Material.VectorExpressions[8] = float4(0.666667,1.000000,1.000000,0.000000);//(Unknown)
	...
	Material.ScalarExpressions[0] = float4(0.000000,4.000000,4.000000,0.412844);//NORMAL ROTATE AMT Frames_X (Unknown) ImposterRoundingOffsetX
	Material.ScalarExpressions[1] = float4(0.250000,-1.570796,0.785398,1.000000);//(Unknown) (Unknown) (Unknown) ZRot
	Material.ScalarExpressions[2] = float4(1.000000,1.000000,1.000000,1.500000);//(Unknown) Brightness (Unknown) Emissive_Power
	Material.ScalarExpressions[3] = float4(0.000000,0.000000,0.000000,0.800000);//(Unknown) Metalic Specular Roughness
	Material.ScalarExpressions[4] = float4(1250.000000,-0.303175,1.000000,4.000000);//Imposter_Size Sprite_Z_Correction Ambient_Occlusion Frames_Y
