Shader "Unreal/MI_Tree_Fern_02_FO"
{
    Properties
    {
		...
		Material_Texture2D_0( "Foliage_Normal", 2D ) = "white" {}
		Material_Texture2D_1( "Foliage_Albedo", 2D ) = "white" {}
		Material_Texture2D_2( "Foliage_Surface", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "MI_Tree_Fern_02_FO.hlsl"
