...
void InitializeExpressions()
{
	...
	Material.VectorExpressions[2] = float4(0.469591,0.840278,0.151717,1.000000);//albedo_color
	Material.VectorExpressions[3] = float4(0.469591,0.840278,0.151717,0.000000);//(Unknown)
	...
	Material.VectorExpressions[15] = float4(0.879746,0.963542,0.324246,1.000000);//Translucency_Color
	Material.VectorExpressions[16] = float4(0.879746,0.963542,0.324246,0.000000);//(Unknown)
	Material.ScalarExpressions[0] = float4(0.750000,0.000000,0.020000,0.400000);//Normal_strengh (Unknown) color_variation desaturate
	...
	Material.ScalarExpressions[3] = float4(5.000000,0.400000,0.000000,-0.444000);//(Unknown) Wind Gust World Scale Wind Angle Offset 1 Wind 1 Shelter Dot Product Modulation 
