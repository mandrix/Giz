...
void InitializeExpressions()
{
	...
	Material.VectorExpressions[2] = float4(1.000000,1.000000,1.000000,1.000000);//AlbedoColor
	...
	Material.ScalarExpressions[1] = float4(1.000000,0.900000,1.000000,2.000000);//Roughness Value Opacity (Unknown) Wind Direction Mask Bias
	...
	Material.ScalarExpressions[3] = float4(8192.000000,10.000000,-0.217400,0.500000);//Directional Per Vertex Wind Offset Rate Random Anim Offset Alpha Anim Offset Values Anim Speed
	...
	Material.ScalarExpressions[5] = float4(0.003000,2.000000,0.000000,1.000000);//Trunk Sway Amount SSS Value __SubsurfaceProfile AO Value
...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat3 Local115 = (Local12.b * Local6.rgb);
	MaterialFloat3 Local116 = (Local115 * Material.ScalarExpressions[5].y);
	MaterialFloat3 Local117 = (Local116 * Material.VectorExpressions[8].rgb);
	MaterialFloat Local118 = (Local12.r * Material.ScalarExpressions[5].w);
	MaterialFloat Local119 = (Parameters.VertexColor.a * Material.ScalarExpressions[6].x);
	MaterialFloat Local120 = (Local118 * Local119);
	MaterialFloat Local121 = min(max(Local120,0.00000000),1.00000000);
	...
	PixelMaterialInputs.Subsurface = MaterialFloat4(Local117,Material.ScalarExpressions[5].z);
	PixelMaterialInputs.AmbientOcclusion = Local121;
