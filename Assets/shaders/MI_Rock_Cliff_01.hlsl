...
void InitializeExpressions()
{
	...
	Material.VectorExpressions[2] = float4(1.000000,0.996678,0.960070,1.000000);//Color_Tint
	Material.VectorExpressions[3] = float4(1.000000,0.996678,0.960070,0.000000);//(Unknown)
	Material.ScalarExpressions[0] = float4(6.000000,0.000000,1.000000,0.500000);//Details_Scale (Unknown) Albedo_Brightness Specular
	Material.ScalarExpressions[1] = float4(0.850000,1.000000,0.000000,0.000000);//Roughness AO_power (Unknown) (Unknown)
