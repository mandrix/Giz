...
void InitializeExpressions()
{
	...
	Material.ScalarExpressions[0] = float4(0.500000,0.000000,-0.200000,1.000000);//Normal_strengh (Unknown) desaturate Brightness
	...
	Material.ScalarExpressions[3] = float4(0.050000,1.000000,1.000000,0.000000);//Wind Horizontal Speed  (Unknown) Wind Gust World Scale Wind Angle Offset 1
	...
	Material.ScalarExpressions[8] = float4(2.000000,200.000000,0.250000,130.000000);//Dampening Radius Multiplier 2 Wind 2 Random Rotation Change Rate Wind 2 Random Rotation Influence Sphere_Mask Radius
	Material.ScalarExpressions[9] = float4(130.000000,0.007692,32.000000,2048.000000);//(Unknown) (Unknown) Object_Scale Wind_Dist_Divide
