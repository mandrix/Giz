...
void InitializeExpressions()
{
	...
	Material.VectorExpressions[8] = float4(4.000000,2.000000,1.000000,0.000000);//(Unknown)
	...
	Material.VectorExpressions[13] = float4(0.050000,0.100000,0.100000,0.100000);//(Unknown)
	...
	Material.ScalarExpressions[0] = float4(1.000000,0.000000,0.100000,1.200000);//Normal_strengh (Unknown) desaturate Brightness
	Material.ScalarExpressions[1] = float4(0.220000,0.850000,0.300000,0.500000);//Specular Roughness Vertex_AO AO_Threshold
	Material.ScalarExpressions[2] = float4(1.000000,0.009174,0.050000,1.000000);//Translucency_Opacity Max Rotation 1 Wind Speed Local Wind Scale 1
	Material.ScalarExpressions[3] = float4(0.100000,4.000000,1.000000,0.000000);//Wind Horizontal Speed  (Unknown) Wind Gust World Scale Wind Angle Offset 1
	...
	Material.ScalarExpressions[6] = float4(1.000000,0.050000,0.000000,0.050000);//Local Wind Scale 2 (Unknown) Wind Angle offset 2 Max Rotation 2
