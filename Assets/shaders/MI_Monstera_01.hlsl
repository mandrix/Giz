...
void InitializeExpressions()
{
	...
	Material.VectorExpressions[8] = float4(5.000000,4.000000,1.000000,0.000000);//(Unknown)
	...
	Material.ScalarExpressions[0] = float4(1.000000,0.000000,0.000000,1.000000);//Normal_strengh (Unknown) desaturate Brightness
	Material.ScalarExpressions[1] = float4(0.220000,0.500000,0.500000,0.500000);//Specular Roughness Vertex_AO AO_Threshold
	...
	Material.ScalarExpressions[5] = float4(2.000000,200.000000,0.250000,1.000000);//Dampening Radius Multiplier 1 Wind 1 Random Rotation Change Rate Wind 1 Random Rotation Influence Local Wind Scale 2
	Material.ScalarExpressions[6] = float4(0.100000,0.000000,0.050000,-0.444000);//(Unknown) Wind Angle offset 2 Max Rotation 2 Wind 2 Shelter Dot Product Modulation 
	Material.ScalarExpressions[7] = float4(-1.250000,-1.250000,-0.444000,2.000000);//Wind 2 Shelter Dot Product Bias  (Unknown) (Unknown) Dampening Radius Multiplier 2
	Material.ScalarExpressions[8] = float4(200.000000,0.250000,150.000000,150.000000);//Wind 2 Random Rotation Change Rate Wind 2 Random Rotation Influence Sphere_Mask Radius (Unknown)
	Material.ScalarExpressions[9] = float4(0.006667,117.408401,2048.000000,2.000000);//(Unknown) Object_Scale Wind_Dist_Divide Wind_Distance_Contrast
	Material.ScalarExpressions[10] = float4(-1.000000,1.000000,0.000000,0.000000);//(Unknown) translucency_blend_albedo __SubsurfaceProfile (Unknown)
...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat3 Local296 = (Local8.rgb * Local15.b);
	MaterialFloat3 Local297 = (Local296 * Material.VectorExpressions[16].rgb);
	MaterialFloat3 Local298 = (Local297 * Material.ScalarExpressions[10].y);
	...
	PixelMaterialInputs.Subsurface = MaterialFloat4(Local298,Material.ScalarExpressions[10].z);
