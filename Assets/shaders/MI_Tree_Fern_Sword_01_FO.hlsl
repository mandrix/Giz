...
void InitializeExpressions()
{
	...
	Material.VectorExpressions[8] = float4(10.000000,2.000000,1.000000,0.000000);//(Unknown)
	...
	Material.VectorExpressions[15] = float4(0.599617,0.600694,0.031286,1.000000);//Translucency_Color
	Material.VectorExpressions[16] = float4(0.599617,0.600694,0.031286,0.000000);//(Unknown)
	Material.ScalarExpressions[0] = float4(0.500000,0.000000,0.050000,0.800000);//Normal_strengh (Unknown) desaturate Brightness
	Material.ScalarExpressions[1] = float4(0.220000,1.000000,0.500000,0.500000);//Specular Roughness Vertex_AO AO_Threshold
	Material.ScalarExpressions[2] = float4(0.900000,0.009174,0.100000,1.000000);//Translucency_Opacity Max Rotation 1 Wind Speed Local Wind Scale 1
	Material.ScalarExpressions[3] = float4(0.050000,10.000000,1.000000,0.000000);//Wind Horizontal Speed  (Unknown) Wind Gust World Scale Wind Angle Offset 1
	...
	Material.ScalarExpressions[9] = float4(150.000000,0.006667,50.000000,2048.000000);//(Unknown) (Unknown) Object_Scale Wind_Dist_Divide
	Material.ScalarExpressions[10] = float4(2.000000,-1.000000,0.850000,0.000000);//Wind_Distance_Contrast (Unknown) translucency_blend_albedo __SubsurfaceProfile
