...
void InitializeExpressions()
{
	...
	Material.VectorExpressions[2] = float4(0.713596,1.000000,0.086832,1.000000);//albedo_color
	Material.VectorExpressions[3] = float4(0.713596,1.000000,0.086832,0.000000);//(Unknown)
	...
	Material.VectorExpressions[8] = float4(11.000000,3.000000,1.000000,0.000000);//(Unknown)
	...
	Material.VectorExpressions[15] = float4(1.000000,0.634959,0.047914,1.000000);//Translucency_Color
	Material.VectorExpressions[16] = float4(1.000000,0.634959,0.047914,0.000000);//(Unknown)
	...
	Material.ScalarExpressions[3] = float4(11.000000,0.100000,0.000000,-0.444000);//(Unknown) Wind Gust World Scale Wind Angle Offset 1 Wind 1 Shelter Dot Product Modulation 
