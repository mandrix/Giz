...
void InitializeExpressions()
{
	...
	Material.ScalarExpressions[0] = float4(2.041666,4.000000,4.000000,1.000000);//NORMAL ROTATE AMT Frames_X (Unknown) ImposterRoundingOffsetX
	Material.ScalarExpressions[1] = float4(0.250000,-1.570796,0.785398,1.000000);//(Unknown) (Unknown) (Unknown) ZRot
	Material.ScalarExpressions[2] = float4(1.000000,1.550000,0.645161,0.150000);//(Unknown) Brightness (Unknown) Emissive_Power
	Material.ScalarExpressions[3] = float4(0.000000,0.000000,0.000000,0.800000);//(Unknown) Metalic Specular Roughness
	Material.ScalarExpressions[4] = float4(426.311493,-0.315874,1.000000,4.000000);//Imposter_Size Sprite_Z_Correction Ambient_Occlusion Frames_Y
