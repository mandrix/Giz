...
void InitializeExpressions()
{
	...
	Material.VectorExpressions[2] = float4(0.958333,0.937234,0.357299,1.000000);//albedo_color
	Material.VectorExpressions[3] = float4(0.958333,0.937234,0.357299,0.000000);//(Unknown)
	...
	Material.VectorExpressions[15] = float4(0.000000,0.000000,0.000000,1.000000);//Translucency_Color
	Material.VectorExpressions[16] = float4(0.000000,0.000000,0.000000,0.000000);//(Unknown)
	Material.ScalarExpressions[0] = float4(1.250000,0.000000,0.200000,0.250000);//Normal_strengh (Unknown) color_variation desaturate
	Material.ScalarExpressions[1] = float4(1.000000,0.500000,1.100000,1.000000);//Brightness Specular Roughness Translucency_Opacity
	...
	Material.ScalarExpressions[3] = float4(3.000000,0.300000,0.000000,-0.444000);//(Unknown) Wind Gust World Scale Wind Angle Offset 1 Wind 1 Shelter Dot Product Modulation 
