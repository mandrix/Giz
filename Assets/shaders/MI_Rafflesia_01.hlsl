...
void InitializeExpressions()
{
	...
	Material.VectorExpressions[2] = float4(0.700000,0.700000,0.700000,1.000000);//Color_Tint
	Material.VectorExpressions[3] = float4(0.700000,0.700000,0.700000,0.000000);//(Unknown)
	Material.ScalarExpressions[0] = float4(0.000000,0.000000,0.000000,0.500000);//Normal_Flatten (Unknown) Metallic Specular
	Material.ScalarExpressions[1] = float4(0.750000,0.000000,0.000000,0.000000);//Roughness_Power (Unknown) (Unknown) (Unknown)
}void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat Local9 = MaterialStoreTexCoordScale(Parameters, Parameters.TexCoords[0].xy, 2);
	...
	MaterialFloat Local12 = (Material.ScalarExpressions[0].z * Local10.b);
	MaterialFloat Local13 = (Material.ScalarExpressions[1].x * Local10.g);
