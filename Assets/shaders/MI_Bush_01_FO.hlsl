...
void InitializeExpressions()
{
	...
	Material.VectorExpressions[4] = float4(0.562907,0.895833,0.124421,1.000000);//Translucency_Color
	Material.VectorExpressions[5] = float4(0.562907,0.895833,0.124421,0.000000);//(Unknown)
	Material.ScalarExpressions[0] = float4(0.900000,0.000000,0.100000,0.220000);//Normal_strengh (Unknown) Albedo_Desaturate Specular
	Material.ScalarExpressions[1] = float4(1.500000,0.900000,1.000000,1.000000);//Roughness Opacity Wind_Speed_Power Wind_Sway_Height
	...
	Material.ScalarExpressions[3] = float4(0.000000,1.756028,2.000000,0.000000);//Leaves Wind Force translucency_blend_albedo Translucency Power __SubsurfaceProfile
