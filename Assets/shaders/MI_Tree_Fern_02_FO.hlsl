...
void InitializeExpressions()
{
	...
	Material.ScalarExpressions[0] = float4(0.000000,0.000000,1.000000,0.220000);//(Unknown) Desaturate Base Color Boost Value Specular
	Material.ScalarExpressions[1] = float4(1.150000,0.050000,1.000000,0.010000);//Roughness Opacity Local Wind Scale 1 Wind Speed
