Shader "Unreal/MI_Rock_Sharp_02"
{
    Properties
    {
		...
		Material_Texture2D_1( "Detail_Normal", 2D ) = "white" {}
		Material_Texture2D_2( "T_Moss_01_N", 2D ) = "white" {}
		Material_Texture2D_3( "Albedo", 2D ) = "white" {}
		Material_Texture2D_4( "T_Moss_01_D", 2D ) = "white" {}
		Material_Texture2D_5( "Surface", 2D ) = "white" {}
