...
void InitializeExpressions()
{
	...
	Material.VectorExpressions[2] = float4(0.675698,0.776042,0.662869,1.000000);//albedo_color
	Material.VectorExpressions[3] = float4(0.675698,0.776042,0.662869,0.000000);//(Unknown)
	...
	Material.VectorExpressions[15] = float4(0.617629,0.775000,0.021792,1.000000);//Translucency_Color
	Material.VectorExpressions[16] = float4(0.617629,0.775000,0.021792,0.000000);//(Unknown)
	Material.ScalarExpressions[0] = float4(1.000000,0.000000,0.150000,0.500000);//Normal_strengh (Unknown) desaturate Brightness
	Material.ScalarExpressions[1] = float4(0.220000,0.600000,0.500000,0.500000);//Specular Roughness Vertex_AO AO_Threshold
	...
	Material.ScalarExpressions[10] = float4(2.000000,-1.000000,1.250000,0.000000);//Wind_Distance_Contrast (Unknown) translucency_blend_albedo __SubsurfaceProfile
