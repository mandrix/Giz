...
void InitializeExpressions()
{
	...
	Material.VectorExpressions[2] = float4(1.000000,0.886295,0.473958,1.000000);//albedo_color
	Material.VectorExpressions[3] = float4(1.000000,0.886295,0.473958,0.000000);//(Unknown)
	...
	Material.VectorExpressions[15] = float4(0.986124,1.000000,0.058055,1.000000);//Translucency_Color
	Material.VectorExpressions[16] = float4(0.986124,1.000000,0.058055,0.000000);//(Unknown)
	Material.ScalarExpressions[0] = float4(1.000000,0.000000,0.020000,0.100000);//Normal_strengh (Unknown) color_variation desaturate
	Material.ScalarExpressions[1] = float4(1.000000,0.220000,0.500000,1.000000);//Brightness Specular Roughness Translucency_Opacity
	...
	Material.ScalarExpressions[3] = float4(7.000000,0.200000,0.000000,-0.444000);//(Unknown) Wind Gust World Scale Wind Angle Offset 1 Wind 1 Shelter Dot Product Modulation 
	...
	Material.ScalarExpressions[9] = float4(0.007634,32.000000,2.000000,0.000000);//(Unknown) Object_Scale translucency_blend_albedo __SubsurfaceProfile
