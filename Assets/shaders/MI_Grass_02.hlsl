...
void InitializeExpressions()
{
	...
	Material.VectorExpressions[2] = float4(0.699653,0.681783,0.231234,1.000000);//albedo_color
	Material.VectorExpressions[3] = float4(0.699653,0.681783,0.231234,0.000000);//(Unknown)
	...
	Material.VectorExpressions[15] = float4(0.862968,1.000000,0.403333,1.000000);//Translucency_Color
	Material.VectorExpressions[16] = float4(0.862968,1.000000,0.403333,0.000000);//(Unknown)
	Material.ScalarExpressions[0] = float4(1.000000,0.000000,0.020000,0.250000);//Normal_strengh (Unknown) color_variation desaturate
	...
	Material.ScalarExpressions[3] = float4(7.000000,0.050000,0.000000,-0.444000);//(Unknown) Wind Gust World Scale Wind Angle Offset 1 Wind 1 Shelter Dot Product Modulation 
