...
void InitializeExpressions()
{
	...
	Material.VectorExpressions[2] = float4(0.804166,0.653586,0.369554,1.000000);//Albedo_Color
	Material.VectorExpressions[3] = float4(0.804166,0.653586,0.369554,0.000000);//(Unknown)
	Material.ScalarExpressions[0] = float4(1.000000,0.000000,1.000000,0.500000);//Bark tiling (Unknown) Albedo_Brightness specular
	Material.ScalarExpressions[1] = float4(1.000000,1.000000,1.000000,1.000000);//Roughness Wind_Speed_Power Wind_Sway Wind_Sway_Power
	Material.ScalarExpressions[2] = float4(1.500000,0.000000,0.000000,0.000000);//AO (Unknown) (Unknown) (Unknown)
...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat Local5 = MaterialStoreTexCoordScale(Parameters, Local0, 1);
	...
	MaterialFloat3 Local9 = (Material.VectorExpressions[3].rgb * Local8);
	MaterialFloat Local10 = MaterialStoreTexCoordScale(Parameters, Parameters.TexCoords[0].xy, 2);
	MaterialFloat4 Local11 = ProcessMaterialLinearColorTextureLookup(Texture2DSampleBias(Material_Texture2D_2, sampler_Material_Texture2D_2,Parameters.TexCoords[0].xy,View.MaterialTextureMipBias));
	MaterialFloat Local12 = MaterialStoreTexSample(Parameters, Local11, 2);
	MaterialFloat Local13 = (Local11.g * Material.ScalarExpressions[1].x);
	MaterialFloat Local47 = (Local11.r * Material.ScalarExpressions[2].x);
