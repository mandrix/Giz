...
void InitializeExpressions()
{
	...
	Material.VectorExpressions[2] = float4(0.496560,0.578125,0.418538,1.000000);//albedo_color
	Material.VectorExpressions[3] = float4(0.496560,0.578125,0.418538,0.000000);//(Unknown)
	...
	Material.VectorExpressions[15] = float4(0.582506,0.640625,0.113444,1.000000);//Translucency_Color
	Material.VectorExpressions[16] = float4(0.582506,0.640625,0.113444,0.000000);//(Unknown)
	Material.ScalarExpressions[0] = float4(1.000000,0.000000,0.200000,1.000000);//Normal_strengh (Unknown) desaturate Brightness
	Material.ScalarExpressions[1] = float4(0.220000,0.900000,0.500000,0.500000);//Specular Roughness Vertex_AO AO_Threshold
	...
	Material.ScalarExpressions[8] = float4(2.000000,200.000000,0.250000,127.300873);//Dampening Radius Multiplier 2 Wind 2 Random Rotation Change Rate Wind 2 Random Rotation Influence Sphere_Mask Radius
	Material.ScalarExpressions[9] = float4(127.300873,0.007855,35.000000,2048.000000);//(Unknown) (Unknown) Object_Scale Wind_Dist_Divide
