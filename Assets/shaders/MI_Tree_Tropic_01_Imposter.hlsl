...
void InitializeExpressions()
{
	...
	Material.ScalarExpressions[0] = float4(0.300000,4.000000,4.000000,0.375000);//NORMAL ROTATE AMT Frames_X (Unknown) ImposterRoundingOffsetX
	...
	Material.ScalarExpressions[3] = float4(0.000000,0.000000,0.220000,0.700000);//(Unknown) Metalic Specular Roughness
	Material.ScalarExpressions[4] = float4(900.000000,-0.188889,1.000000,4.000000);//Imposter_Size Sprite_Z_Correction Ambient_Occlusion Frames_Y
