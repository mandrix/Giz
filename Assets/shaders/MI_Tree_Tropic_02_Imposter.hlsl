...
void InitializeExpressions()
{
	...
	Material.ScalarExpressions[2] = float4(1.000000,1.000000,1.000000,1.000000);//(Unknown) Brightness (Unknown) Emissive_Power
	Material.ScalarExpressions[3] = float4(0.000000,0.000000,0.000000,0.800000);//(Unknown) Metalic Specular Roughness
	Material.ScalarExpressions[4] = float4(1200.000000,-0.506349,1.000000,4.000000);//Imposter_Size Sprite_Z_Correction Ambient_Occlusion Frames_Y
