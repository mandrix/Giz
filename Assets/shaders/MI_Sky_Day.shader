Shader "Unreal/MI_Sky_Day"
{
    Properties
    {
		...
		Material_Texture2D_0( "Sky_Albedo", 2D ) = "white" {}
		Material_Texture2D_1( "Sky_Mask", 2D ) = "white" {}
		Material_Texture2D_2( "Cloud_Mask_Horizon", 2D ) = "white" {}
		Material_Texture2D_3( "Sky_Mask_Cloud_02", 2D ) = "white" {}
