...
void InitializeExpressions()
{
	...
	Material.VectorExpressions[2] = float4(0.346924,0.453125,0.395996,1.000000);//albedo_color
	Material.VectorExpressions[3] = float4(0.346924,0.453125,0.395996,0.000000);//(Unknown)
	...
	Material.VectorExpressions[8] = float4(3.000000,3.000000,1.000000,0.000000);//(Unknown)
	...
	Material.VectorExpressions[15] = float4(0.572917,0.568146,0.032502,1.000000);//Translucency_Color
	Material.VectorExpressions[16] = float4(0.572917,0.568146,0.032502,0.000000);//(Unknown)
	Material.ScalarExpressions[0] = float4(0.400000,0.000000,0.100000,0.900000);//Normal_strengh (Unknown) desaturate Brightness
	Material.ScalarExpressions[1] = float4(0.220000,0.850000,0.400000,0.500000);//Specular Roughness Vertex_AO AO_Threshold
	...
	Material.ScalarExpressions[3] = float4(0.050000,3.000000,1.000000,0.000000);//Wind Horizontal Speed  (Unknown) Wind Gust World Scale Wind Angle Offset 1
	...
	Material.ScalarExpressions[10] = float4(2.000000,-1.000000,0.500000,0.000000);//Wind_Distance_Contrast (Unknown) translucency_blend_albedo __SubsurfaceProfile
