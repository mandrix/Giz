...
void InitializeExpressions()
{
	...
	Material.ScalarExpressions[2] = float4(1.000000,1.330000,0.751880,0.350000);//(Unknown) Brightness (Unknown) Emissive_Power
	Material.ScalarExpressions[3] = float4(0.000000,0.000000,0.000000,0.800000);//(Unknown) Metalic Specular Roughness
	Material.ScalarExpressions[4] = float4(90.000000,-0.411112,1.000000,4.000000);//Imposter_Size Sprite_Z_Correction Ambient_Occlusion Frames_Y
