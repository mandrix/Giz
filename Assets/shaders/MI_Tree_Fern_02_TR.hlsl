...
void InitializeExpressions()
{
	...
	Material.ScalarExpressions[0] = float4(1.000000,0.000000,1.500000,1.000000);//Trunk_Scale (Unknown) Base Color Boost Value Trunk_Specular
	Material.ScalarExpressions[1] = float4(1.000000,0.050000,1.000000,0.010000);//Trunk_Roughness Opacity Local Wind Scale 1 Wind Speed
