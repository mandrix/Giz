...
void InitializeExpressions()
{
	...
	Material.ScalarExpressions[0] = float4(5.000000,3.000000,1.500000,1.500000);//Details_Scale Moss_Tiling Blend_Normal WorldBlendMax
	...
	Material.ScalarExpressions[2] = float4(0.500000,0.500000,0.500000,1.050000);//Moss_Edge_Brightness Moss_Darkness_Core Specular Roughness
