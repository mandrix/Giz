...
void InitializeExpressions()
{
	...
	Material.VectorExpressions[2] = float4(0.301353,0.494792,0.291941,1.000000);//albedo_color
	Material.VectorExpressions[3] = float4(0.301353,0.494792,0.291941,0.000000);//(Unknown)
	Material.VectorExpressions[4] = float4(0.621248,0.848958,0.070094,1.000000);//Translucency_Color
	Material.VectorExpressions[5] = float4(0.621248,0.848958,0.070094,0.000000);//(Unknown)
	Material.ScalarExpressions[0] = float4(0.500000,0.000000,0.020000,2.500000);//Normal_strengh (Unknown) desaturate Brightness
	Material.ScalarExpressions[1] = float4(0.220000,1.500000,0.500000,0.500000);//Specular Roughness Vertex_AO AO_Threshold
	Material.ScalarExpressions[2] = float4(0.200000,3.000000,0.000000,0.000000);//Translucency_Opacity translucency_blend_albedo __SubsurfaceProfile (Unknown)
