...
void InitializeExpressions()
{
	...
	Material.VectorExpressions[4] = float4(0.670038,0.781250,0.067817,1.000000);//Translucency_Color
	Material.VectorExpressions[5] = float4(0.670038,0.781250,0.067817,0.000000);//(Unknown)
	...
	Material.ScalarExpressions[2] = float4(1.000000,1.000000,0.000000,0.000000);//Translucency_Opacity translucency_blend_albedo __SubsurfaceProfile (Unknown)
...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat3 Local28 = (Local9.rgb * Local16.b);
	MaterialFloat3 Local29 = (Local28 * Material.VectorExpressions[5].rgb);
	MaterialFloat3 Local30 = (Local29 * Material.ScalarExpressions[2].y);
	...
	PixelMaterialInputs.Subsurface = MaterialFloat4(Local30,Material.ScalarExpressions[2].z);
